...
from .utils import start_local_connection, ALICE_IDENTITY, TEST_FARM_NAME
...
def test_create_farm():
    ...
    test_farm_id = Farm.create(
        substrate, ALICE_IDENTITY, TEST_FARM_NAME, [PublicIP(ip="1.1.1.1", gw="1.1.1.1", contract_id=0)]
    )
...
def test_get_farm_id_by_name():
    ...
    farm_id = Farm.get_farm_id_by_name(substrate, TEST_FARM_NAME)
